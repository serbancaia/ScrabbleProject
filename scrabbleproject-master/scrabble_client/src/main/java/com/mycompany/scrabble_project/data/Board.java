...
public class Board {
    ...
    /**
     * This method checks if coordinates x and y
     * are on a DL Tile.
     * 
     * @param DLTiles - array of DL Tiles
     * @param x - row index on board
     * @param y - column index on board
     * @return - true if x and y are on a DL Tile
     * @param DLTiles
     */
     ...
     * are on a DW Tile.
     * 
     * @param DWTiles - array of DW Tiles
     * @param x - row index on board
     * @param y - column index on board
     * @return - true if x and y are on a DW Tile
     */
     ...
     * are on a TL Tile.
     * 
     * @param TLTiles - array of TL Tiles
     * @param x - row index on board
     * @param y - column index on board
     * @return - true if x and y are on a TL Tile
     */
     ...
     * are on a TW Tile.
     * 
     * @param TWTiles - array of TW Tiles
     * @param x - row index on board
     * @param y - column index on board
     * @return - true if x and y are on a TW Tile
     */
